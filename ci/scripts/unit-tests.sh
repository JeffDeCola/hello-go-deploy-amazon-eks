...
echo "The goal is to set up a go src/github.com/JeffDeCola/hello-go-deploy-amazon-eks directory"
...
echo "cp -R ./hello-go-deploy-amazon-eks src/github.com/JeffDeCola/."
...
# echo "mkdir -p test"
# mkdir -p test
# echo "Placeholder to run go tests for hello-go-deploy-amazon-eks" | tee test/test_coverage.txt
# echo " "
