...
echo "   /hello-go-deploy-amazon-eks"
...
echo "cp -r hello-go-deploy-amazon-eks/hello-go-deploy-amazon-eks-code/* dist"
cp -r hello-go-deploy-amazon-eks/hello-go-deploy-amazon-eks-code/* dist
echo " "
...
#echo "Now we must move our code from the current directory ./hello-go-deploy-amazon-eks to" 
#echo "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-eks"
#mkdir -p src/github.com/JeffDeCola/
#cp -R ./hello-go-deploy-amazon-eks src/github.com/JeffDeCola/.
#echo " "

#echo "cd src/github.com/JeffDeCola/hello-go-deploy-amazon-eks/hello-go-deploy-amazon-eks-code"
#cd src/github.com/JeffDeCola/hello-go-deploy-amazon-eks/hello-go-deploy-amazon-eks-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-eks/hello-go-deploy-amazon-eks-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-eks/hello-go-deploy-amazon-eks-code/build-push/Dockerfile" .
#echo " "
